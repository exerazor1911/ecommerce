...
const Counterp = (props) => {
    ...
    const functionSumar = () => {
       count < props.stock ? setCount(count + 1) /* && (props.stock = props.stock -1) */ : <ReactBootStrap.Button disabled onClick={functionSumar} style={{width: '25%'}} className="inner-button-suma" variant="warning">+</ReactBootStrap.Button>
    }
